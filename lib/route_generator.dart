import 'package:bejaii_grocery/src/pages/notifications.dart';
...
import 'src/pages/delivery_map_screen.dart';
import 'src/pages/bankak_checkout.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/BankakCheckout':
        return MaterialPageRoute(builder: (_) => BankakCheckoutWidget());
      case '/notifications':
      ...
      case '/DeliveryAddress':
        return MaterialPageRoute(builder: (_) => DeliveryMapScreen());
      case '/Gallery':
        return MaterialPageRoute(
            builder: (_) =>
