...
class S {
 ...
 String get didnotReceiveTheCode {
  ...
  String get ok {
   ...
   String get  pleaseAddCountryCode {
    return Intl.message(
      ' Please add country code(+249)',
      name: 'pleaseAddCountryCode',
      desc: '',
      args: [],
    );
  }
  ...
  String get thePasswordFieldIsMandatory {
    return Intl.message(
      'The Password field is mandatory',
      name: 'thePasswordFieldIsMandatory',
      desc: '',
      args: [],
    );
  }
 ...
 /// `Click to pay with your bankak account`
  String get click_to_pay_with_your_bankak_account {
    return Intl.message(
      'Click to pay with your Bankak account',
      name: 'click_to_pay_with_your_bankak_account',
      desc: '',
      args: [],
    );
  }
  ...
  String orderThisorderidHasBeenCanceled(Object random_number) {
    return Intl.message(
      'Order: #$random_number has been canceled',
  ...
  String get verifyPhoneNumber {
   ...
   String get smsHasBeenSentTo2 {
    return Intl.message(
      'SMS has been sent to ',
      name: 'smsHasBeenSentTo2',
      desc: '',
      args: [],
    );
  }
