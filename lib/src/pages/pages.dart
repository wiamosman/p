    ...
    setState(() {
      ...
      switch (tabItem) {
        ...
        //   break;
           case 0:
          print("1");
          widget.currentPage = Offers(parentScaffoldKey: widget.scaffoldKey);//MessagesWidget(parentScaffoldKey: widget.scaffoldKey); //FavoritesWidget(parentScaffoldKey: widget.scaffoldKey);
          break;
        // case 1:
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            // ),
                BottomNavigationBarItem(
              icon: new Icon(widget.currentTab == 1 ? Icons.local_offer : Icons.local_offer),
              label: '',
            ),
            BottomNavigationBarItem(
                label: '',
