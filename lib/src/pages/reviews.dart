                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                             ...
                             style: TextButton.styleFrom(    primary: Theme.of(context).primaryColor,
                               backgroundColor: Theme.of(context).accentColor,padding: EdgeInsets.symmetric(vertical: 10, horizontal: 18),  shape: StadiumBorder(),),
                                 ...
                                 TextButton.icon(
                                    ...
                                    icon: Icon(
                                     ...
                                     style: TextButton.styleFrom(    primary: Theme.of(context).accentColor,
                                       backgroundColor:  Theme.of(context).primaryColor, padding: EdgeInsets.symmetric(vertical: 10, horizontal: 18),  shape: StadiumBorder(),),
                                 )
