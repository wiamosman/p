...
import '../elements/notification_Button_widget.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: List.generate(
              ...
              print(settingsRepo.setting.value.homeSections.length);
              print(settingsRepo.setting.value.homeSections);
              String _homeSection =
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  "Where to deliver", // S.of(context).delivery,
                                  style: TextStyle(
                            ...
                            //               ? Theme.of(context).hintColor
                            //               : Theme.of(context).primaryColor),
                            //       //    print( settingsRepo.deliveryAddress.value?.address);
                            //     ),
                            //   ),
                            // ),
                          ],
                          ...
                          Padding(
                            ...
                            child:
                              ...
                              TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: settingsRepo.deliveryAddress.value
                                                ?.description !=
                                            null
                                        ? (settingsRepo
