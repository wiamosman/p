                  ...
                  child: Column(
                    children: <Widget>[
                      MaterialButton(
                        ...
                        onPressed: () {
                         // Navigator.of(context).pushNamed('/Pages', arguments: new RouteArgument(id: '1', param: market));//lazim yamshi almap
                        },
                        child: Icon(Icons.social_distance, color: Theme.of(context).primaryColor),
