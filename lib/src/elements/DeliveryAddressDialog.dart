...
//            contentPadding: EdgeInsets.symmetric(horizontal: 20),
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new TextFormField(
                        ...
                        decoration: getInputDecoration(hintText: S.of(context).home_address, labelText: S.of(context).description,enable:true),
                        initialValue: address.description?.isNotEmpty ?? false ? address.description : null,
                        validator: (input) => input.trim().isEmpty ? S.of(context).notValidAddressDescription : null,
                    ...
                    Padding(
                      ...
                      child:  TextFormField(
                        ...
                        decoration: getInputDecoration(
                          ...
                          hintText: "Map address",//S.of(context).hint_full_address, 
                        
                        labelText:"Map address",enable:false),// S.of(context).full_address),
  ...
  InputDecoration getInputDecoration({String hintText, String labelText ,bool enable }) {
