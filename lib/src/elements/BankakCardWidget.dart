...
class BankakCardsWidget extends StatelessWidget {
 BankakId bankakID;
  ValueChanged< BankakId> onChanged;
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    // Image.asset(
                    //   'assets/img/Bank_of_Khartoum_logo.png',
                    //   height: 30,//22,
                    //   width: 70,
                    // ),
                    Spacer(),
                ...
                Row(
                  ...
                  children: <Widget>[
                     Text(
               "Transaction ID",//   S.of(context).card_number,
                  style: Theme.of(context).textTheme.caption,
                ),
                    Text(
                  Helper.getBankakTrxIDNumber(bankakID.transactionId),
