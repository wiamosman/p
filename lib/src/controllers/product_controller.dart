  ...
  void listenForProduct({String productId, String message}) async {
    ...
    stream.listen((Product _product) {
      ...
      ScaffoldMessenger.of(scaffoldKey?.currentContext).showSnackBar(SnackBar(
        content: Text(S.of(state.context).verify_your_internet_connection), duration: Duration(seconds: 3),
      ));
    }, onDone: () {
      calculateTotal();
      if (message != null) {
        ...
        setState(() {
          this.loadCart = false;
             ...
             showDialog(
                    ...
                    builder: (ctx) => AlertDialog(
                        content: Text(
   S.of(state.context).this_product_was_added_to_cart,
    ...
    addFavorite(_favorite).then((value) {
      setState(() {
       ...
       showDialog(
                    ...
                    builder: (ctx) => AlertDialog(
                        content: Text(
  S.of(state.context).thisProductWasAddedToFavorite,
    ...
    removeFavorite(_favorite).then((value) {
      setState(() {
       ...
       showDialog(
                    ...
                    builder: (ctx) => AlertDialog(
                        content: Text(
 S.of(state.context).thisProductWasRemovedFromFavorites,
